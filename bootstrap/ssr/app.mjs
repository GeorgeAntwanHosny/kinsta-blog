...
/* empty css       */import { createApp, h as h$1 } from "vue";
...
createInertiaApp({
  ...
  resolve: (name) => resolvePageComponent(
    `./Pages/${name}.vue`,
    /* @__PURE__ */ Object.assign({ "./Pages/Index.vue": () => import("./assets/Index-5537ce74.mjs"), "./Pages/Show.vue": () => import("./assets/Show-2b41d136.mjs") })
  ),
  setup: function({ el, app, props, plugin }) {
    return createApp({ render: () => h$1(app, props) }).use(plugin).use(I).mount(el);
  }
});
