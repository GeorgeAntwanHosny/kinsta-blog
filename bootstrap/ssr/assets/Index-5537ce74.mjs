...
import { K as KinstaLayout } from "./KinstaLayout-48d2c2b1.mjs";
...
const _sfc_main = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[-->`);
      _push(ssrRenderComponent(unref(Head), { title: "Kinsta Blog" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<meta name="description" content="Kinsta blog for developers"${_scopeId}>`);
          } else {
            return [
              createVNode("meta", {
                name: "description",
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            ssrRenderList(__props.articles, (article) => {
              _push2(`<article class="flex justify-center items-center shadow-md bg-white rounded-xl p-4 mx-auto max-w-3xl"${_scopeId}><img class="w-40 h-40 rounded-l-xl mx-auto"${ssrRenderAttr("src", article.image_url)} alt="Example Image"${_scopeId}><div class="flex flex-col text-left justify-between pl-3 space-y-5"${_scopeId}><h3 class="text-xl font-semibold text-indigo-600 hover:text-indigo-800"${_scopeId}>`);
              _push2(ssrRenderComponent(unref(Link), {
                href: unref(route)("article.show", article.id),
                "preserve-scroll": ""
              }, {
              ...
              createVNode("section", { class: "space-y-5 border-b-2 pb-10" }, [
                ...
                (openBlock(true), createBlock(Fragment, null, renderList(__props.articles, (article) => {
                  return openBlock(), createBlock("article", {
                    ...
                    createVNode("img", {
                      class: "w-40 h-40 rounded-l-xl mx-auto",
